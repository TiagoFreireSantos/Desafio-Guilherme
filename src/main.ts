...
const contagemDeBlocosEmLinha = 3
    ...
    for (let l = 0; l < contagemDeBlocosEmLinha; l++) {
      ...
      if (bloco.estado === 1) {
        if (
          ...
          if (pontosPorRodada == contagemDeBlocosEmLinha * contagemDeBlocosEmColuna) {
            alert('Você ganhou, parabéns')
            pontosPorRodada = 0
            x = canvas.width / 2
            y = canvas.height - 30
            raqueteX = (canvas.width - larguraDaRaquete) 
